...
function Services() {
    return (
        <section id="services" className="py-20 bg-rose-200">
            <div className="max-w-7xl mx-auto px-4">
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    {[
                        ...
                        <motion.div data-aos="zoom-out-left" key={s.t} whileHover={{ y: -6 }} className="bg-gradient-to-r from-rose-300 to-white rounded-2xl overflow-hidden bg-white shadow">
