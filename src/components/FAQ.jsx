...
function FAQItem({ f }) {
    ...
    return (
        <div className="border rounded-2xl p-5 bg-rose-100 shadow-md">
            ...
            <div
                className={`grid transition-all duration-500 ease-in-out ${open ? "grid-rows-[1fr] opacity-100 mt-3" : "grid-rows-[0fr] opacity-0"}`}
            >
                <div className="overflow-hidden">
                    <p className="text-gray-600 italic">{f.a}</p>
                </div>
            </div>
        </div>
    );
