...
function Gallery() {
    return (
        <section id="gallery" className="py-20 bg-rose-200">
            <div className="max-w-7xl mx-auto px-4">
                <h2 className="text-5xl font-extrabold text-center mb-12">
                    <span>Ga</span><span className="text-red-600 italic">lle</span><span>ry</span>
                </h2>
                <p className="text-center text-gray-600 max-w-2xl italic mx-auto mb-12">A glimpse into our weddings, receptions, sangeets & corporate soirées.</p>
                <div className="columns-1 sm:columns-2 lg:columns-3 gap-4 [column-fill:_balance]">
                    {[
                        ...
                        <motion.img
                            ...
                            alt={`event-${i}`}
                            loading="lazy"
                            className="mb-4 w-full wrap-anywher rounded-2xl shadow-md break-inside-avoid transition-transform duration-300 hover:scale-105"
