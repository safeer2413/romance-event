...
//     return (
//         <section id="packages" className="overflow-x-hidden py-20 bg-gradient-to-b from-white to-rose-300">
...
//                             className={`overflow-x-hidden rounded-2xl border shadow-md p-6 bg-gradient-to-b from-rose-300 to-white ${p.tag ? "bg-rose-50 border-rose-200" : "bg-white"
//                                 }`}
//                         >
...
//                             </ul>
//                             <Button href="#contact" className="mt-6 inline-block w-full text-center px-5 py-3 rounded-xl bg-rose-600 text-white hover:bg-rose-700">Enquire Now</Button>
...
function Pricing() {
  const plans = [
    ...
    },
    {
      ...
      feats: [
        ...
        "Emcee + DJ + Dance floor",
      ],
    },
    {
      name: "Grandeur (Premium)",
      price: "₹2,49,999",
      feats: [
        "Luxury décor & truss lighting",
  ...
  return (
    <section
      id="packages"
      className="overflow-x-hidden py-20 bg-gradient-to-b from-white to-rose-300"
    >
      <div className="max-w-7xl mx-auto px-4">
        <h2
          className="text-4xl md:text-5xl font-extrabold text-center tracking-tight mb-12"
          data-aos="fade-up"
        >
          <span className="text-black">Pop</span>
          <span className="text-red-600 italic">ular </span>
          <span className="text-red-600 italic">Pack</span>
          <span className="text-black">age</span>
        </h2>

        <p
          className="text-center text-gray-600 max-w-2xl italic mx-auto mb-12"
          data-aos="fade-up"
          data-aos-delay="100"
        >
          Transparent bundles that can be tailored to your guest count and
          theme.
        </p>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {plans.map((p, i) => (
            <div
              ...
              className={`w-full rounded-2xl border shadow-md p-6 transition-transform duration-300 hover:-translate-y-2 ${
                p.tag ? "bg-rose-50 border-rose-200" : "bg-white"
              }`}
            >
              {p.tag && (
                <div className="inline-block text-xs px-3 py-1 mb-3 rounded-full bg-rose-600 text-white">
                  {p.tag}
                </div>
              )}
              ...
              <a
                href="#contact"
                className="mt-6 inline-block w-full text-center px-5 py-3 rounded-xl bg-rose-600 text-white hover:bg-rose-700"
              >
                Enquire Now
              </a>
            </div>
